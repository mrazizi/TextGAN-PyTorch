...
from models.TGAN_G import TGAN_G
from utils import rollout
from utils.data_loader import GenDataIter, DisDataIter


class TGANInstructor(BasicInstructor):
    def __init__(self, opt):
        super(TGANInstructor, self).__init__(opt)

        # generator, discriminator
        self.gen = TGAN_G(cfg.gen_embed_dim, cfg.gen_hidden_dim, cfg.vocab_size, cfg.max_seq_len,
